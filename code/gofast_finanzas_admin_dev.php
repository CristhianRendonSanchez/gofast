...
function gofast_finanzas_admin_dev_shortcode() {
    ...
    if (isset($_POST['gofast_registrar_pago_mensajero_dev']) && wp_verify_nonce($_POST['gofast_pago_mensajero_dev_nonce'], 'gofast_registrar_pago_mensajero_dev')) {
    ...
    if (isset($_POST['gofast_editar_pago_mensajero_dev']) && wp_verify_nonce($_POST['gofast_editar_pago_dev_nonce'], 'gofast_editar_pago_mensajero_dev')) {
    ...
    if (isset($_POST['gofast_eliminar_pago_mensajero_dev']) && wp_verify_nonce($_POST['gofast_eliminar_pago_dev_nonce'], 'gofast_eliminar_pago_mensajero_dev')) {
        $pago_id = (int) ($_POST['pago_id'] ?? 0);
    ...
    // 1. CREAR EGRESO
    if (isset($_POST['gofast_crear_egreso_dev']) && wp_verify_nonce($_POST['gofast_egreso_dev_nonce'], 'gofast_crear_egreso_dev')) {
        $fecha = sanitize_text_field($_POST['fecha'] ?? '');
    ...
    // 2. EDITAR EGRESO
    if (isset($_POST['gofast_editar_egreso_dev']) && wp_verify_nonce($_POST['gofast_editar_egreso_dev_nonce'], 'gofast_editar_egreso_dev')) {
    ...
    // 3. ELIMINAR EGRESO
    if (isset($_POST['gofast_eliminar_egreso_dev']) && wp_verify_nonce($_POST['gofast_eliminar_egreso_dev_nonce'], 'gofast_eliminar_egreso_dev')) {
        $egreso_id = (int) $_POST['egreso_id'];
    ...
    if (isset($_POST['gofast_crear_vale_empresa_dev']) && wp_verify_nonce($_POST['gofast_vale_empresa_dev_nonce'], 'gofast_crear_vale_empresa_dev')) {
        $fecha = sanitize_text_field($_POST['fecha'] ?? '');
        $descripcion = sanitize_text_field($_POST['descripcion'] ?? '');
        $valor = floatval($_POST['valor'] ?? 0);
    ...
    if (isset($_POST['gofast_editar_vale_empresa_dev']) && wp_verify_nonce($_POST['gofast_editar_vale_empresa_dev_nonce'], 'gofast_editar_vale_empresa_dev')) {
    ...
    if (isset($_POST['gofast_eliminar_vale_empresa_dev']) && wp_verify_nonce($_POST['gofast_eliminar_vale_empresa_dev_nonce'], 'gofast_eliminar_vale_empresa_dev')) {
        $vale_id = (int) $_POST['vale_id'];
    ...
    if (isset($_POST['gofast_crear_vale_personal_dev']) && wp_verify_nonce($_POST['gofast_vale_personal_dev_nonce'], 'gofast_crear_vale_personal_dev')) {
        $fecha = sanitize_text_field($_POST['fecha'] ?? '');
    ...
    if (isset($_POST['gofast_editar_vale_personal_dev']) && wp_verify_nonce($_POST['gofast_editar_vale_personal_dev_nonce'], 'gofast_editar_vale_personal_dev')) {
        $vale_id = (int) $_POST['vale_id'];
        $fecha = sanitize_text_field($_POST['fecha'] ?? '');
        $persona_id = (int) ($_POST['persona_id'] ?? 0);
        $descripcion = sanitize_text_field($_POST['descripcion'] ?? '');
    ...
    if (isset($_POST['gofast_eliminar_vale_personal_dev']) && wp_verify_nonce($_POST['gofast_eliminar_vale_personal_dev_nonce'], 'gofast_eliminar_vale_personal_dev')) {
        $vale_id = (int) $_POST['vale_id'];
    ...
    if (isset($_POST['gofast_crear_transferencia_salida_dev']) && wp_verify_nonce($_POST['gofast_transferencia_salida_dev_nonce'], 'gofast_crear_transferencia_salida_dev')) {
        $fecha = sanitize_text_field($_POST['fecha'] ?? '');
        $descripcion = sanitize_text_field($_POST['descripcion'] ?? '');
        $valor = floatval($_POST['valor'] ?? 0);
    ...
    if (isset($_POST['gofast_editar_transferencia_salida_dev']) && wp_verify_nonce($_POST['gofast_editar_transferencia_salida_dev_nonce'], 'gofast_editar_transferencia_salida_dev')) {
    ...
    if (isset($_POST['gofast_eliminar_transferencia_salida_dev']) && wp_verify_nonce($_POST['gofast_eliminar_transferencia_salida_dev_nonce'], 'gofast_eliminar_transferencia_salida_dev')) {
        $transferencia_id = (int) $_POST['transferencia_id'];
    ...
    // 1. CREAR DESCUENTO
    if (isset($_POST['gofast_crear_descuento_dev']) && wp_verify_nonce($_POST['gofast_descuento_dev_nonce'], 'gofast_crear_descuento_dev')) {
        $fecha = sanitize_text_field($_POST['fecha'] ?? '');
        $mensajero_id = (int) ($_POST['mensajero_id'] ?? 0);
        $valor = floatval($_POST['valor'] ?? 0);
        $descripcion = sanitize_text_field($_POST['descripcion'] ?? '');
    ...
    // 2. EDITAR DESCUENTO
    if (isset($_POST['gofast_editar_descuento_dev']) && wp_verify_nonce($_POST['gofast_editar_descuento_dev_nonce'], 'gofast_editar_descuento_dev')) {
    ...
    if (isset($_POST['gofast_eliminar_descuento_dev']) && wp_verify_nonce($_POST['gofast_eliminar_descuento_dev_nonce'], 'gofast_eliminar_descuento_dev')) {
        $descuento_id = (int) $_POST['descuento_id'];
    ...
    if ($es_rango_especifico) {
        ...
        // Total Transferencias Ingresos (aprobadas, todas las transferencias: normales y de tipo 'pago')
        ...
        // Total Transferencias Ingresos hasta fecha_hasta (todas las transferencias: normales y de tipo 'pago')
        $total_transferencias_ingresos = (float) ($wpdb->get_var(
            $wpdb->prepare(
        ...
        <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.2);">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
                ...
                <div style="background: rgba(255,255,255,0.2); padding: 16px; border-radius: 8px;">
                    ...
                    <div style="font-size: 11px; opacity: 0.85; line-height: 1.5; border-top: 1px solid rgba(255,255,255,0.3); padding-top: 8px; margin-top: 8px;">
                        <strong>Detalle:</strong><br>
                        Subtotal - Transferencias - Vales Personal<br>
                        <small style="opacity: 0.7;">$<?= number_format($subtotal, 0, ',', '.') ?> - $<?= number_format($saldo_transferencias, 0, ',', '.') ?> - $<?= number_format($total_vales_personal, 0, ',', '.') ?></small>
                    </div>
                </div>
                <div style="background: rgba(255,255,255,0.2); padding: 16px; border-radius: 8px;">
                    <div style="font-size: 13px; opacity: 0.9; margin-bottom: 6px;">
    ...
    <div class="gofast-box" style="margin-bottom: 20px;">
        ...
        <div id="tab-egresos" class="gofast-config-tab-content" style="display: <?= $tab_activo === 'egresos' ? 'block' : 'none' ?>;">
            ...
            <div class="gofast-box" style="background: #f8f9fa; margin-bottom: 20px;">
                ...
                <form method="post">
                    <?php wp_nonce_field('gofast_crear_egreso_dev', 'gofast_egreso_dev_nonce'); ?>
                    ...
                    <button type="submit" name="gofast_crear_egreso_dev" class="gofast-btn-mini">✅ Crear Egreso</button>
                </form>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space:nowrap;">
                                            ...
                                            <form method="post" style="display:inline-block;margin-left:4px;" onsubmit="return confirm('¿Estás seguro de eliminar este egreso? Esta acción no se puede deshacer.');">
                                                <?php wp_nonce_field('gofast_eliminar_egreso_dev', 'gofast_eliminar_egreso_dev_nonce'); ?>
                                                <input type="hidden" name="egreso_id" value="<?= esc_attr($egreso->id) ?>">
                                                <button type="submit" name="gofast_eliminar_egreso_dev" class="gofast-btn-mini" style="background:#dc3545;color:#fff;">
                                                    🗑️ Eliminar
                                                </button>
                                            </form>
                                        </td>
        ...
        <div id="modal-editar-egreso" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:10000;overflow-y:auto;padding:20px;">
            <div style="max-width:600px;margin:20px auto;background:#fff;border-radius:8px;padding:20px;box-shadow:0 4px 20px rgba(0,0,0,0.3);">
                ...
                <form method="post" id="form-editar-egreso">
                    <?php wp_nonce_field('gofast_editar_egreso_dev', 'gofast_editar_egreso_dev_nonce'); ?>
                    ...
                    <div style="display:flex;gap:8px;justify-content:flex-end;margin-top:16px;padding-top:16px;border-top:1px solid #ddd;">
                        ...
                        <button type="submit" name="gofast_editar_egreso_dev" class="gofast-btn-mini">Guardar Cambios</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div id="tab-vales_empresa" class="gofast-config-tab-content" style="display: <?= $tab_activo === 'vales_empresa' ? 'block' : 'none' ?>;">
            ...
            <div class="gofast-box" style="background: #f8f9fa; margin-bottom: 20px;">
                ...
                <form method="post">
                    <?php wp_nonce_field('gofast_crear_vale_empresa_dev', 'gofast_vale_empresa_dev_nonce'); ?>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px; margin-bottom: 12px;">
                        <div>
                            <label style="display: block; font-weight: 600; margin-bottom: 4px; font-size: 13px;">Fecha <span style="color: #dc3545;">*</span></label>
                            <input type="date" 
                    ...
                    <button type="submit" name="gofast_crear_vale_empresa_dev" class="gofast-btn-mini">✅ Crear Vale</button>
                </form>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space:nowrap;">
                                            ...
                                            <form method="post" style="display:inline-block;margin-left:4px;" onsubmit="return confirm('¿Estás seguro de eliminar este vale? Esta acción no se puede deshacer.');">
                                                <?php wp_nonce_field('gofast_eliminar_vale_empresa_dev', 'gofast_eliminar_vale_empresa_dev_nonce'); ?>
                                                <input type="hidden" name="vale_id" value="<?= esc_attr($vale->id) ?>">
                                                <button type="submit" name="gofast_eliminar_vale_empresa_dev" class="gofast-btn-mini" style="background:#dc3545;color:#fff;">
                                                    🗑️ Eliminar
                                                </button>
                                            </form>
                                        </td>
        ...
        <div id="modal-editar-vale-empresa" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:10000;overflow-y:auto;padding:20px;">
            <div style="max-width:600px;margin:20px auto;background:#fff;border-radius:8px;padding:20px;box-shadow:0 4px 20px rgba(0,0,0,0.3);">
                ...
                <form method="post" id="form-editar-vale-empresa">
                    <?php wp_nonce_field('gofast_editar_vale_empresa_dev', 'gofast_editar_vale_empresa_dev_nonce'); ?>
                    ...
                    <div style="display:flex;gap:8px;justify-content:flex-end;margin-top:16px;padding-top:16px;border-top:1px solid #ddd;">
                        ...
                        <button type="submit" name="gofast_editar_vale_empresa_dev" class="gofast-btn-mini">Guardar Cambios</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div id="tab-vales_personal" class="gofast-config-tab-content" style="display: <?= $tab_activo === 'vales_personal' ? 'block' : 'none' ?>;">
            ...
            <div class="gofast-box" style="background: #f8f9fa; margin-bottom: 20px;">
                ...
                <form method="post">
                    <?php wp_nonce_field('gofast_crear_vale_personal_dev', 'gofast_vale_personal_dev_nonce'); ?>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px; margin-bottom: 12px;">
                        <div>
                            <label style="display: block; font-weight: 600; margin-bottom: 4px; font-size: 13px;">Fecha <span style="color: #dc3545;">*</span></label>
                            <input type="date" 
                    ...
                    <button type="submit" name="gofast_crear_vale_personal_dev" class="gofast-btn-mini">✅ Crear Vale</button>
                </form>
            </div>
                                ...
                                <?php foreach ($vales_personal as $vale): ?>
                                    <tr>
                                        ...
                                        <td style="white-space:nowrap;">
                                            ...
                                            <form method="post" style="display:inline-block;margin-left:4px;" onsubmit="return confirm('¿Estás seguro de eliminar este vale? Esta acción no se puede deshacer.');">
                                                <?php wp_nonce_field('gofast_eliminar_vale_personal_dev', 'gofast_eliminar_vale_personal_dev_nonce'); ?>
                                                <input type="hidden" name="vale_id" value="<?= esc_attr($vale->id) ?>">
                                                <button type="submit" name="gofast_eliminar_vale_personal_dev" class="gofast-btn-mini" style="background:#dc3545;color:#fff;">
                                                    🗑️ Eliminar
                                                </button>
                                            </form>
                                        </td>
        ...
        <div id="modal-editar-vale-personal" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:10000;overflow-y:auto;padding:20px;">
            <div style="max-width:600px;margin:20px auto;background:#fff;border-radius:8px;padding:20px;box-shadow:0 4px 20px rgba(0,0,0,0.3);">
                ...
                <form method="post" id="form-editar-vale-personal">
                    <?php wp_nonce_field('gofast_editar_vale_personal_dev', 'gofast_editar_vale_personal_dev_nonce'); ?>
                    ...
                    <div style="display:flex;gap:8px;justify-content:flex-end;margin-top:16px;padding-top:16px;border-top:1px solid #ddd;">
                        ...
                        <button type="submit" name="gofast_editar_vale_personal_dev" class="gofast-btn-mini">Guardar Cambios</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div id="tab-transferencias_salidas" class="gofast-config-tab-content" style="display: <?= $tab_activo === 'transferencias_salidas' ? 'block' : 'none' ?>;">
            ...
            <div class="gofast-box" style="background: #f8f9fa; margin-bottom: 20px;">
                ...
                <form method="post">
                    <?php wp_nonce_field('gofast_crear_transferencia_salida_dev', 'gofast_transferencia_salida_dev_nonce'); ?>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px; margin-bottom: 12px;">
                        <div>
                            <label style="display: block; font-weight: 600; margin-bottom: 4px; font-size: 13px;">Fecha <span style="color: #dc3545;">*</span></label>
                            <input type="date" 
                    ...
                    <button type="submit" name="gofast_crear_transferencia_salida_dev" class="gofast-btn-mini">✅ Crear Transferencia</button>
                </form>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space:nowrap;">
                                            ...
                                            <form method="post" style="display:inline-block;margin-left:4px;" onsubmit="return confirm('¿Estás seguro de eliminar esta transferencia? Esta acción no se puede deshacer.');">
                                                <?php wp_nonce_field('gofast_eliminar_transferencia_salida_dev', 'gofast_eliminar_transferencia_salida_dev_nonce'); ?>
                                                <input type="hidden" name="transferencia_id" value="<?= esc_attr($transf->id) ?>">
                                                <button type="submit" name="gofast_eliminar_transferencia_salida_dev" class="gofast-btn-mini" style="background:#dc3545;color:#fff;">
                                                    🗑️ Eliminar
                                                </button>
                                            </form>
                                        </td>
        ...
        <div id="modal-editar-transf-salida" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:10000;overflow-y:auto;padding:20px;">
            <div style="max-width:600px;margin:20px auto;background:#fff;border-radius:8px;padding:20px;box-shadow:0 4px 20px rgba(0,0,0,0.3);">
                ...
                <form method="post" id="form-editar-transf-salida">
                    <?php wp_nonce_field('gofast_editar_transferencia_salida_dev', 'gofast_editar_transferencia_salida_dev_nonce'); ?>
                    ...
                    <div style="display:flex;gap:8px;justify-content:flex-end;margin-top:16px;padding-top:16px;border-top:1px solid #ddd;">
                        ...
                        <button type="submit" name="gofast_editar_transferencia_salida_dev" class="gofast-btn-mini">Guardar Cambios</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div id="tab-descuentos" class="gofast-config-tab-content" style="display: <?= $tab_activo === 'descuentos' ? 'block' : 'none' ?>;">
            ...
            <div class="gofast-box" style="background: #f8f9fa; margin-bottom: 20px;">
                ...
                <form method="post">
                    <?php wp_nonce_field('gofast_crear_descuento_dev', 'gofast_descuento_dev_nonce'); ?>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px; margin-bottom: 12px;">
                        <div>
                            <label style="display: block; font-weight: 600; margin-bottom: 4px; font-size: 13px;">Fecha <span style="color: #dc3545;">*</span></label>
                            <input type="date" 
                    ...
                    <button type="submit" name="gofast_crear_descuento_dev" class="gofast-btn-mini">✅ Crear Descuento</button>
                </form>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space:nowrap;">
                                            ...
                                            <form method="post" style="display:inline-block;margin-left:4px;" onsubmit="return confirm('¿Estás seguro de eliminar este descuento? Esta acción no se puede deshacer.');">
                                                <?php wp_nonce_field('gofast_eliminar_descuento_dev', 'gofast_eliminar_descuento_dev_nonce'); ?>
                                                <input type="hidden" name="descuento_id" value="<?= esc_attr($descuento->id) ?>">
                                                <button type="submit" name="gofast_eliminar_descuento_dev" class="gofast-btn-mini" style="background:#dc3545;color:#fff;">
                                                    🗑️ Eliminar
                                                </button>
                                            </form>
                                        </td>
        ...
        <div id="modal-editar-descuento" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:10000;overflow-y:auto;padding:20px;">
            <div style="max-width:600px;margin:20px auto;background:#fff;border-radius:8px;padding:20px;box-shadow:0 4px 20px rgba(0,0,0,0.3);">
                ...
                <form method="post" id="form-editar-descuento">
                    <?php wp_nonce_field('gofast_editar_descuento_dev', 'gofast_editar_descuento_dev_nonce'); ?>
                    ...
                    <div style="display:flex;gap:8px;justify-content:flex-end;margin-top:16px;padding-top:16px;border-top:1px solid #ddd;">
                        ...
                        <button type="submit" name="gofast_editar_descuento_dev" class="gofast-btn-mini">Guardar Cambios</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="gofast-modal-content" style="max-width: 420px;">
        ...
        <div class="gofast-modal-footer">
            <form id="form-editar-pago" method="post" action="" style="display: flex; gap: 12px; width: 100%;">
                <?php wp_nonce_field('gofast_editar_pago_mensajero_dev', 'gofast_editar_pago_dev_nonce'); ?>
                <input type="hidden" name="pago_id" id="editar-pago-id">
                <input type="hidden" name="tab" value="saldos_mensajeros">
                <input type="hidden" name="subtab_saldos" value="historial_pagos">
                
                <button type="submit" name="gofast_editar_pago_mensajero_dev" class="gofast-btn" style="flex: 1; background: #ffc107; color: #000; border: none; padding: 12px 20px; border-radius: 8px; font-weight: 600; cursor: pointer;">
                    💾 Guardar Cambios
                </button>
    ...
    <div class="gofast-modal-content" style="max-width: 420px;">
        ...
        <div class="gofast-modal-footer">
            <form method="post" action="" style="display: flex; gap: 12px; width: 100%;">
                <?php wp_nonce_field('gofast_eliminar_pago_mensajero_dev', 'gofast_eliminar_pago_dev_nonce'); ?>
                <input type="hidden" name="pago_id" id="eliminar-pago-id">
                <input type="hidden" name="tab" value="saldos_mensajeros">
                <input type="hidden" name="subtab_saldos" value="historial_pagos">
                
                <button type="submit" name="gofast_eliminar_pago_mensajero_dev" class="gofast-btn" style="flex: 1; background: #dc3545; color: #fff; border: none; padding: 12px 20px; border-radius: 8px; font-weight: 600; cursor: pointer;">
                    🗑️ Sí, Eliminar
                </button>
...
<div id="modal-registrar-pago" class="gofast-modal" style="display: none;">
    <div class="gofast-modal-content" style="max-width: 500px;">
        ...
        <form id="form-registrar-pago" method="post">
            <?php wp_nonce_field('gofast_registrar_pago_mensajero_dev', 'gofast_pago_mensajero_dev_nonce'); ?>
            <input type="hidden" name="gofast_registrar_pago_mensajero_dev" value="1">
