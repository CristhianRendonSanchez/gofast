 ...
 * Shortcode: [gofast_reportes_financieros_dev]
...
function gofast_reportes_financieros_dev_shortcode() {
    global $wpdb;
...
<div class="container">
    ...
    <div class="section">
        ...
        <table>
            ...
            // Agregar Historial de Pagos justo después de la tabla de saldos
            $total_pagos = 0;
            $reporte_html .= '
    <div class="section">
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                // Agregar Historial de Pagos justo después de la tabla de saldos en email
                $total_pagos_email_saldos = 0;
                $email_html .= '
            <div class="section">
                <h3>📋 Historial de Pagos</h3>
                <table>
                ...
                foreach ($pagos_historial as $pago) {
                    $total_pagos_email_saldos += (float)$pago->total_a_pagar;
                    $email_html .= '
                        <tr>
                            <td>' . gofast_date_format($pago->fecha, 'd/m/Y') . '</td>
                            <td>' . esc_html($pago->mensajero_nombre ?? 'N/A') . '</td>
                ...
                $email_html .= '
                        <tr class="total-row">
                            <td colspan="3"><strong>Total Pagos</strong></td>
                            <td class="text-right positive"><strong>$' . number_format($total_pagos_email_saldos, 0, ',', '.') . '</strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>';
...
add_shortcode('gofast_reportes_financieros_dev', 'gofast_reportes_financieros_dev_shortcode');
